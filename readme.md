...
### Script tag
- Put a script tag similar to this `<script src='https://unpkg.com/@idli/idli-table@0.1.1/dist/idli-table.js'></script>` in the head of your index.html
...
<custom-element-demo>
  <template>
    <script src='https://unpkg.com/@idli/idli-table@0.1.1/dist/idli-table.js'></script>
    <div style="width: 80%">
          <idli-table
