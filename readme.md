...
### Script tag
- Put a script tag similar to this `<script src='https://unpkg.com/@idli/idli-table@0.6.5/dist/idli-table.js'></script>` in the head of your index.html
- Then you can use the element anywhere in your template, JSX, html etc

### Node Modules
- Run `npm install @idli/idli-table --save`
- Put a script tag similar to this `<script src='node_modules/@idli/idli-table/dist/idli-table.js'></script>` in the head of your index.html
- Then you can use the element anywhere in your template, JSX, html etc

### In a stencil-starter app
- Run `npm install @idli/idli-table --save`
- Add an import to the npm packages `import @idli/idli-table;`
- Then you can use the element anywhere in your template, JSX, html etc
...
<custom-element-demo>
  <template>
    <script src='https://unpkg.com/@idli/idli-table@0.6.5/dist/idli-table.js'></script>
    <div style="width: 80%">
          <idli-table
...
<head>
    ...
    <script type="module" src="/build/idli-table.esm.js"></script>
    <script nomodule src="/build/idli-table.js"></script>
