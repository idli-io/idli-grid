...
### Script tag
- Put a script tag similar to this `<script src='https://unpkg.com/@idli/idli-grid@0.1.5/dist/idli-grid.js'></script>` in the head of your index.html
...
<custom-element-demo>
  <template>
    ...
    <idli-grid size="lg" variant="primary">Click me</idli-grid>
  </template>
</custom-element-demo>
```
-->
